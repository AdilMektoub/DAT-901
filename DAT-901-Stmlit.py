...
#Const
filename = "/home/adil/DAT-901/KaDo_less.csv"
path_image = "/home/adil/DAT-901/cadeau.png"
...
if nav == "À propos":
    ...
    image = Image.open("/home/adil/DAT-901/image.jpg")
    col1.image(image)
    col1.markdown("<h2 style='text-align: center'>Adil 1</h1>", unsafe_allow_html=True)

    image1 = Image.open("/home/adil/DAT-901/image1.jpg")
    col2.image(image1)
    col2.markdown("<h2 style='text-align: center'>Adil 2</h1>", unsafe_allow_html=True)

    image2 = Image.open("/home/adil/DAT-901/image2.jpg")
    col3.image(image2)
    col3.markdown("<h2 style='text-align: center'>Adil 3</h1>", unsafe_allow_html=True)
